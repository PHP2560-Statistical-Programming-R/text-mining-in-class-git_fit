...
#book<-prisoner_of_azkaban

#Q: What are the most common words by chapter?
#data_frame(text = book) %>%
#mutate(chapter=c(1:length(book))) %>%
...
ggplot(POA,aes(x=chapter))+
  geom_bar(aes(fill=sentiment)) +
  ggtitle("Emotion Per Chapter in Prisoner of Azkaban") +
  coord_flip()
```
...
```{r}
stopwords<- c("this", "is", "are", "a", "the", "he", "you", "your", "and", "on","to","of")
```
